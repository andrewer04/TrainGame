...
public class CrossRail extends Rail {
     ...
     * @param possibleRail3 harmadik lehetseges tovabbhaladasi irány tarolva van ebben
     */
    ...
    /*
    * Haladasi irany beallitasa
    * @param possibleRail3 negyedik lehetseges tovabbhaladasi irany tarolva van ebben
    */
